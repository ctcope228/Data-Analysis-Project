...
I decided to alter my original "GameData" component to just be a "PlayerData" component, I think this makes much more sense for the project because my original idea wasn't really possible without first making "PlayerData". I think my other two components are equally feasible but I chose this one because it is something I'm more familiar with.
...
- Designed a proof of concept for PlayerData component
